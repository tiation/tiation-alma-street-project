---
layout: default
title: Tiation Alma Street Project - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Alma Street Project</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-alma-street-project" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t tiation-alma-street-project .

# Run container
docker run -p 8080:8080 tiation-alma-street-project
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-alma-street-project)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-alma-street-project/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-alma-street-project/discussions)
